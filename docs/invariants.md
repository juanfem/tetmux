...
Split out of `CLAUDE.md`, which holds the orientation and the guidance index. Read this before
changing code in the areas it names — every entry is a real shipped or nearly-shipped failure.
